# Generated by Django 2.2.3 on 2019-10-07 12:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gerente_Area_Dev', models.CharField(blank=True, max_length=128, verbose_name='Gerente da Área de Desenvolvimento')),
                ('coordenador_Area_Dev', models.CharField(blank=True, max_length=128, verbose_name='Coordenador da Área de Desenvolvimento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gerente_Area_Sup', models.CharField(blank=True, max_length=128, verbose_name='Gerente da Área de Suporte')),
                ('coordenador_Area_Sup', models.CharField(blank=True, max_length=128, verbose_name='Coordenador da Área de Suporte')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cadeia_Servico', models.CharField(max_length=128, verbose_name='Cadeia de Serviço')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_Area_Dev', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Area_Desenvolvimento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_Area_Sup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Area_Suporte')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topologia', models.URLField(blank=True, max_length=250, verbose_name='Topologia')),
                ('cod_Cadeia_Servico', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Cadeia_Servico')),
                ('cod_Criticidade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Criticidade_Suporte')),
                ('cod_Responsavel_Dev', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Responsavel_Desenvolvimento')),
                ('cod_Responsavel_Sup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Responsavel_Suporte')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servico', models.CharField(blank=True, max_length=255, verbose_name='Serviço')),
                ('cod_Sistema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Sistema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('janela_Critica', models.CharField(max_length=128, verbose_name='Janela Crítica')),
                ('cod_Sistema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Sistema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_Impacto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Impacto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao_Impacto_Potencial', models.CharField(max_length=255, verbose_name='Impacto(s) Potencial(is)')),
                ('cod_Impacto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Impacto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fronteira', models.CharField(blank=True, max_length=128, verbose_name='Fronteira(s)')),
                ('cod_impacto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Impacto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependencia', models.CharField(blank=True, max_length=128, verbose_name='Dependência(s)')),
                ('cod_Impacto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Impacto')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='cod_Sistema',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Sistema'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_Continuidade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Continuidade_Tecnologica')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_Contingencia', models.CharField(max_length=128, verbose_name='Contingência Usuário')),
                ('cod_Contingencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Contingencia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cod_Nome', models.AutoField(primary_key=True, serialize=False)),
                ('nome_Contingencia', models.CharField(max_length=128, verbose_name='Contingência Arquitetura')),
                ('cod_Contingencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.t_Contingencia')),
            ],
            options={
